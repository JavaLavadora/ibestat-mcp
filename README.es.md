...
Construido sobre la API eDades de [IBESTAT](https://ibestat.es). Diseñado para [Claude Desktop](https://claude.ai), [Claude Code](https://claude.com/claude-code) y cualquier cliente compatible con MCP.
